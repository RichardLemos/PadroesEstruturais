...
import domain.Caminho;
import domain.Trecho;
import domain.TrechoAndando;
import domain.TrechoDeCarro;
...
public class TestaCaminho {
	public static void main(String[] args) {
		...
		Trecho trecho2 = new TrechoDeCarro("Vá até o cruzamento da Av. Brigadeiro Faria Lima com a Av. Cidade Jardim ",
				1500);
